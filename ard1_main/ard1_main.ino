...
void UpdateMPPTin(){
  ...
  */
  mppt_in = (potencia_mppt1+potencia_mppt2+potencia_mppt3+potencia_mppt4)*10; // Dividir por 10 en Tablet
}
/*///////////////////////// UPDATE VELOCIDAD //////////////////////////*/
...
void Send_tablet_data(){
  if((millis() - last_tablet_send) > tiempoEnvioTablet){
    if(aux_tablet == 0){
      ...
      Serial.print("e,");Serial.print(mppt_in);Serial.print("\n"); // MPPT IN IN WHATTS mppt_in
      delay(delay_speed);
      Send_speed();
      aux_tablet = 4;
      last_tablet_send = millis();
...
/*////////////////////// RECEIVE MPPTS //////////////////////*/
  ...
  if(ET_MPPT.receiveData()){
    ...
    potencia_mppt1= (mppt_data.Uin_1*mppt_data.Iin_1)/1000000; //Potencia
    ...
    potencia_mppt2= (mppt_data.Uin_2*mppt_data.Iin_2)/1000000; //Potencia
    ...
    potencia_mppt3= (mppt_data.Uin_3*mppt_data.Iin_3)/1000000; //Potencia
    ...
    potencia_mppt4= (mppt_data.Uin_4*mppt_data.Iin_4)/1000000; //Potencia
  }
